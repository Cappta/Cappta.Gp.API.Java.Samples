...
public interface IClienteCappta extends Com4jObject {
  ...
  int pagamentoCrediario(
    double valor,
    Com.Api.Java.IDetalhesCrediario detalhes);
  ...
  int pagamentoCredito(
    double valor,
    Com.Api.Java.IDetalhesCredito detalhes);
  ...
  @VTID(18)
  Com.Api.Java.IIteracaoTef iterarOperacaoTef();
  ...
  java.lang.String solicitarInformacoesPinpad(
    Com.Api.Java.IRequisicaoInformacaoPinpad requisicaoPinpad);
  ...
  @VTID(20)
  int configurar(
    Com.Api.Java.IConfiguracoes configs);
  ...
  int pagamentoTicketCarPessoaFisica(
    double valor,
    Com.Api.Java.IDetalhesPagamentoTicketCarPessoaFisica detalhes);
  ...
  @VTID(22)
  Com.Api.Java.IDetalhesOperadoras obterOperadoras();
  ...
  @VTID(23)
  Com.Api.Java.IDetalhesProdutosOperadoras obterProdutosOperadoras(
  ...
  @VTID(25)
  Com.Api.Java.IRespostaLoja obterLojas();
  ...
  @VTID(26)
  int ativarLoja(
    Com.Api.Java.IDetalheLoja loja);
  ...
  @VTID(27)
  Com.Api.Java.IIteracaoTef recargaCelular(
    Com.Api.Java.IDetalhesRecarga detalhes);
