...
public interface IDetalhesRecarga extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type Com.Api.Java.IProdutoRecarga
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(15)
  Com.Api.Java.IProdutoRecarga produto();
   ...
   * </p>
   * @param pRetVal Mandatory Com.Api.Java.IProdutoRecarga parameter.
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(16)
  void produto(
    Com.Api.Java.IProdutoRecarga pRetVal);
