...
public interface IDetalhesRecarga extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type Api_Com_Cappta_Java.IProdutoRecarga
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(15)
  cappta.Gp.Api.Com.Interfaces.IProdutoRecarga produto();
   ...
   * </p>
   * @param pRetVal Mandatory Api_Com_Cappta_Java.IProdutoRecarga parameter.
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(16)
  void produto(
    cappta.Gp.Api.Com.Interfaces.IProdutoRecarga pRetVal);
